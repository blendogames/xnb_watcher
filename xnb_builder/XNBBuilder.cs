...
namespace XNAConverter
{
    public class XNBBuilder : BuildContent
    {
        ...
        public string[] PackageContent(string[] fileNames, string outputDirectory, bool shouldLog, string rootDirectory,  out List<string> errorArray, out List<string> outputFiles, out bool buildStatus)
        {
            ...
            try
            {
                ...
                errorArray = buildEngine.GetErrors();
                ...
                if (this.OutputContentFiles != null)
                {
                    ...
                    for (int i = 0; i < processedFileNames.Length; ++i)
                    {
                        ...
                        outputFiles.Add(processedFileNames[i]);
                    }
                }
            }
            catch { }
